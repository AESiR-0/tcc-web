...
import niraj from "@/public/static/Niraj.jpg";
// import pradeep from "@/public/static/Pradeep.HEIC";
...
export default function DirectorNotes() {
  ...
  return (
    <>
      <div className="text-5xl font-bold text-center my-3">
        Director&apos;s Note
      </div>
      <p className="my-6 text-center px-48 text-lg">
        Our team is the backbone of our success. Comprising industry veterans,
        skilled engineers, and dedicated support staff, we work collaboratively
        to achieve our goals. Key members include:
      </p>
      ...
      <div className=" w-full flex gap-10 justify-center">
        {notes.map((note, index) => (
          <div
            ...
            key={index}
            className=" w-72 px-6  h-fit hover:bg-blue-500 hover:scale-95 hover:cursor-pointer transition-all "
          >
